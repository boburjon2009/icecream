import { Facebook, Instagram, MoveLeft, MoveRight, Youtube, ArrowRight } from "lucide-react";
import { Link } from "react-router-dom";
import { useState } from "react";

// VAQTINCHA: Barcha rasm importlarini commentga olamiz
// import loveIcecream from "../imgs/love-icecream.png";
// import missionTriangle from "../imgs/mission-triangle.png";
// import missionCross from "../imgs/mission-cross.png";
// import missionWave from "../imgs/mission-wave.png";
...
export default function AboutHeader() {
  // Team data - vaqtincha img propertylarini olib tashlaymiz
  const team = [
    { id: 1, name: "Marvin Joner", role: "Bakery Worker" },
    { id: 2, name: "Patricia Woodrum", role: "Staff Worker" },
    { id: 3, name: "Hannaz Stone", role: "Shop Worker" },
    { id: 4, name: "Sophia Lee", role: "Ice Cream Designer" },
    { id: 5, name: "James Carter", role: "Marketing" },
    { id: 6, name: "Olivia Brown", role: "Cashier" },
  ];
  ...
  return (
    <div>
      ...
      <div className="mt-[5%] mb-[5%] relative">
        <div className="w-[70%] flex justify-center items-center m-auto relative">
          <div className="w-[90%]">
            <img src="src/imgs/right-3.png" alt="Love Icecream" />
          </div>
          <div className="ml-[10%]">
      ...
      {/* Mission */}
      <div className="w-full bg-[#683292] flex justify-end relative py-20">
        <div className="w-[75%] flex justify-end relative">
          ...
          <div>
            {/* <img src={girlsIcecream} alt="Girls Icecream" /> */}
      ...
      <div className="mt-[5%] mb-[5%]">
        ...
        <div className="w-[50%] flex m-auto justify-between mt-[3%]">
          <div className="bg-white p-4 rounded-2xl border-b-2 border-[#F83D8E] text-center">
      ...
      <div className="py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-3">Get to know the friendly faces behind your favorite flavors.</p>
        </div>

        <div className="relative w-[90%] mx-auto flex items-center justify-center">
          {/* Prev Button */}
          <button onClick={prevSlide} className="p-3 absolute left-0">
            <MoveLeft />
          </button>
          ...
          <div className="flex gap-10 justify-center">
            {team.slice(index, index + 3).map((member) => (
              <div key={member.id} className="flex flex-col items-center p-6 w-[280px]">
                <div className="w-40 h-40 rounded-full mb-4 bg-gray-200 flex items-center justify-center">
                  Rasm
                </div>
          ...
          {/* Next Button */}
          <button onClick={nextSlide} className="p-3 absolute right-0 hover:bg-pink-100">
            <MoveRight />
          </button>
        </div>
      </div>
